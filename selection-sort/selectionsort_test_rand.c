/* ================================================================================================================
 * Name: selectionsort_test_rand.c
 * Description: A simple function to sort an array of large size using Selection sort
 * Input(s):
...
void selectionsort_test_rand(void){
    ...
    // function call for quick sort
	  	  selection_sort(test_input_arr, rand_arr_size);
